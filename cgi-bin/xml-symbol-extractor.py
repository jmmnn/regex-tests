...
def symbol_extractor (file):
	""" Usage, start cgi server $ python -m CGIHTTPServer then go to: http://localhost:8000/cgi-bin/xml-symbol-extractor.py  it returns xml of document symbols found in the given file.\n\
